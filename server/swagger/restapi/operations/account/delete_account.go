...
type DeleteAccountHandlerFunc func(DeleteAccountParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteAccountHandlerFunc) Handle(params DeleteAccountParams, principal *models.Principal) middleware.Responder {
	return fn(params, principal)
}

// DeleteAccountHandler interface for that can handle valid delete account params
type DeleteAccountHandler interface {
	Handle(DeleteAccountParams, *models.Principal) middleware.Responder
}
...
/* DeleteAccount swagger:route DELETE /account/authorization/{employeeID} account deleteAccount
